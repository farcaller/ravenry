...
abstract class _RootStore with Store {
  ...
  List<ResModel> get awakeChars {
    final awakeCi = client.get('core.chars.awake');
    if (awakeCi == null) return [];
    final awake = awakeCi.item as ResModel;
    return awake.toJson().values.map((e) => e as ResModel).toList();
  }
}
